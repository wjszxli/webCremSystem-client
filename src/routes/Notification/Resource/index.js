...
const optionsData = ['教育亲子', '食品', '美妆个护', '电商', '综合', '男装', '女装', '其它']
...
export default Form.create()(
  class Resource extends React.Component {
    ...
    getPageData = (pageIndex, searchData) => {
      ...
      API.getNotificationData(pageIndex, searchItem).then(({ listData, dataCount }) => {
        ...
        <div style={{ marginBottom: '10px' }}>
          {
            isAuthFlag && (
              <span>
                ...
                <Button type="primary" onClick={this.deleteNotification}>删除</Button>
              </span>
            )}
        </div>
      )
            ...
            <Col md={8} sm={24}>
              <FormItem label="达人名称">
                {getFieldDecorator('publicNumber', {
                  initialValue: '',
                })(<Input placeholder="输入达人名称搜索" style={{ width: '90%' }} />)}
              </FormItem>
            </Col>
            <Col md={8} sm={24}>
              <FormItem label="类型">
