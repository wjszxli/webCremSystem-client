                ...
                <FormItem {...formItemLayout} label="投放形式">
                  {getFieldDecorator('location', {
                    ...
                    <Select style={{ width: '90%' }} placeholder="选择类型搜索">
                      <Option value="top">混播</Option>
                      <Option value="second">专场</Option>
                      <Option value="other">纯佣</Option>
                    </Select>)}
                </FormItem>
              </Col>
            </Row>
              ...
              <Col span={12}>
                <FormItem {...formItemLayout} label="税点">
                  {getFieldDecorator('taxRouter', {
                    ...
                    <Select style={{ width: '90%' }} onChange={this.handleImpost} defaultValue={6} placeholder="选择税点">
